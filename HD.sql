...
BEGIN TRANSACTION;
CREATE TABLE IF NOT EXISTS employee(Employee_id integer primary key not null, Name text not null, Driving_license_ID integer not null, Status_ID integer not null, Schedule_ID integer);
