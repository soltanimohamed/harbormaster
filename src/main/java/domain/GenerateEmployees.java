...
public class GenerateEmployees {
	...
	public static ArrayList<Employee> generateAllEmployees(){
		Random random = new Random();
		int employeesQ1 = 165; //Anställda i kaj 1
		int employeesQ2 = 195; //Anställda i kaj 2
		int employeesQ3 = 240; //Anställda i kaj 3
